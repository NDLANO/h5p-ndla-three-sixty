import { DEFAULT_RATIO, FOV_PANORAMA, FOV_SPHERE } from '@services/constants';

import Util from '@services/util';
import Initialization from '@mixins/initialization';
import ElementHandling from '@mixins/element-handling';
...
export default class NDLAThreeSixty extends H5P.EventDispatcher {
  ...
  constructor(sourceElement, options) {
    ...
    Util.addMixins(
      NDLAThreeSixty, [Initialization, ElementHandling, SphereHandling]
    );
